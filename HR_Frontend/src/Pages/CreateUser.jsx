...
const CreateUser = () => {
  ...
  const fetchClients = async () => {
    try {
      ...
      const response = await fetch("https://myuandwebackend.vercel.app/api/demand/clients/list");
...
if ((formData.role === "Interviewer" || formData.role === "Client Interviewer") && formData.assignedClient) {
  ...
  console.log(`Updating user ${editingUser.username} - Role: ${formData.role}`);
    ...
    const response = await fetch(`https://myuandwebackend.vercel.app/api/users/${encodeURIComponent(editingUser.username)}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
...
const handleDelete = async (username) => {
  ...
  try {
    const response = await fetch(`https://myuandwebackend.vercel.app/api/users/${encodeURIComponent(username)}`, {
      method: "DELETE",
    });
        ...
        <div className="min-h-screen bg-white/50 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center bg-white p-8 rounded-2xl shadow-xl">
              ...
              <p className="text-gray-600 mb-4">Cannot connect to https://myuandwebackend.vercel.app/</p>
